...
Gui::init_deck1_area()
{
    ...
    this->deck1_remaining_time_layout->addWidget(this->deck1_key,                      100, Qt::AlignRight);
...
Gui::init_deck2_area()
{
    ...
    this->deck2_remaining_time_layout->addWidget(this->deck2_key,                      100, Qt::AlignRight);
