...
void DigitalScratchApi_Test::l_dscratch_analyze_timecode_V2(DSCRATCH_VINYLS vinyl_type, const char *txt_timecode_file)
{
    DSCRATCH_HANDLE handle = nullptr;
...
void DigitalScratchApi_Test::testCase_dscratch_analyze_timecode_serato_stop_fast_V2()
{
    l_dscratch_analyze_timecode_V2(SERATO, TIMECODE_SERATO_33RPM_STOP_FAST);
}
